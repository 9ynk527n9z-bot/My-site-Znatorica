...
export default function EnglishAnimalsTrainerPage() {
  return (
    <div className="bg-[#28134f] min-h-screen">
      <div className="bg-[#1E1035] border-b border-[#2D2350] px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">🇬🇧 Животные по-английски</h1>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-10 text-center">
        <ShareButtons
          text="Животных по-английски учим с озвучкой на Знаторике — попробуйте тоже:"
          url="https://znatorica.ru/trenazher/english-animals"
          trackKey="english-animals"
        />
      </div>
    </div>
  );
