...
export default function EnglishClothesTrainerPage() {
  return (
    <div className="bg-[#28134f] min-h-screen">
      <div className="bg-[#1E1035] border-b border-[#2D2350] px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">🇬🇧 Одежда по-английски</h1>
      </div>

      <TrainerGate type="trainer:english-clothes">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-10 text-center">
        <ShareButtons
          text="Одежду по-английски учим с озвучкой на Знаторике — попробуйте тоже:"
          url="https://znatorica.ru/trenazher/english-clothes"
          trackKey="english-clothes"
        />
      </div>
    </div>
  );
