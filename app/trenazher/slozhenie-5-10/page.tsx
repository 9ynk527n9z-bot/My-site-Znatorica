...
function makeRound(): Round {
  // Подбираем два слагаемых от 1 до 10 так, чтобы сумма была в пределах 5-10
  let a = 0;
  let b = 0;
  let answer = 0;
  do {
...
export default function Slozhenie5_10TrainerPage() {
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">➕ Сложение 5-10</h1>
      </div>

      <TrainerGate type="trainer:slozhenie-5-10">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card mb-8 text-center">
              <p className="text-lg text-white/90 mb-6">
                Реши 10 примеров на сложение чисел в пределах 10. Выбери правильный ответ из вариантов!
              </p>
