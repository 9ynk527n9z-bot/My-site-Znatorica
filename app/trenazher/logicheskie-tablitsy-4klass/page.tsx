...
import { pickLogicTableTasks4Klass, type LogicTableTask4Klass } from '@/lib/logicheskie-tablitsy-4klass';
...
export default function LogicheskieTablitsy4KlassTrainerPage() {
  const [started, setStarted] = useState(false);
  const [rounds, setRounds] = useState<LogicTableTask4Klass[]>([]);
  ...
  function begin() {
    ...
    setRounds(pickLogicTableTasks4Klass(ROUNDS_PER_SESSION));
    setFeedback(null);
    setPickedIndex(null);
  }
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">🧩 Логические задачи с таблицами (4 класс)</h1>
      </div>

      <TrainerGate type="trainer:logicheskie-tablitsy-4klass">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card mb-8 text-center">
              <p className="text-lg text-white/90 mb-6">
                Реши 10 задач «кто есть кто». Прочитай условие внимательно, последовательно исключай
                невозможные варианты и выбери единственно верный ответ.
              </p>
