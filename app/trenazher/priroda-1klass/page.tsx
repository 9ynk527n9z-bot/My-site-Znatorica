...
import { PRIRODA_ITEMS, shufflePriroda, type PrirodaItem } from '@/lib/priroda-1klass';
...
export default function Priroda1klassTrainerPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <TrainerGate type="trainer:priroda-1klass">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card bg-white text-center py-10">
              <p className="text-xl font-bold text-[#3a1c6e] mb-4">
                Определи: это живое или неживое?
              </p>
              <p className="text-gray-600 mb-8">
                Кошки, собаки, цветы и рыбки живые — они растут, едят и дышат.
                Дом, машина, книга или мяч — неживые: их сделали или они просто есть в природе.
              </p>
          ...
          {started && !finished && current && (
            <div className="card bg-white text-center">
              ...
              <p className="text-lg font-bold text-[#3a1c6e] mb-4">Это живое или неживое?</p>
              ...
              <div className="h-8">
                ...
                {feedback === 'wrong' && (
                  <p className="text-red-500 font-black text-xl">
                    Правильно: {current.kind === 'zhivaya' ? '🌱 Живое' : '🪨 Неживое'}
                  </p>
                )}
              </div>
            </div>
