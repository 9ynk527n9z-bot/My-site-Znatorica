...
import { pickVzveshivanie3Klass, type VzveshivanieTask3Klass } from '@/lib/vzveshivanie-3klass';
...
export default function Vzveshivanie3KlassTrainerPage() {
  const [started, setStarted] = useState(false);
  const [rounds, setRounds] = useState<VzveshivanieTask3Klass[]>([]);
  ...
  function begin() {
    ...
    setRounds(pickVzveshivanie3Klass(ROUNDS_PER_SESSION));
    setFeedback(null);
    setPickedIndex(null);
  }
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">⚖️ Задачи на взвешивание (3 класс)</h1>
      </div>

      <TrainerGate type="trainer:vzveshivanie-3klass">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card mb-8 text-center">
              <p className="text-lg text-white/90 mb-6">
                Реши 10 задач на чашечные весы: сколько взвешиваний нужно, чтобы найти фальшивую монету,
                и сколько весит предмет, если весы в равновесии. Прочитай условие внимательно и выбери
                верный числовой ответ.
              </p>
