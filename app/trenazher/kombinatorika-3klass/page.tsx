...
import { pickKombinatorikaTasks3Klass, type KombinatorikaTask3Klass } from '@/lib/kombinatorika-3klass';
...
export default function Kombinatorika3KlassTrainerPage() {
  const [started, setStarted] = useState(false);
  const [rounds, setRounds] = useState<KombinatorikaTask3Klass[]>([]);
  ...
  function begin() {
    ...
    setRounds(pickKombinatorikaTasks3Klass(ROUNDS_PER_SESSION));
    setFeedback(null);
    setPickedIndex(null);
  }
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">🔢 Комбинаторика (3 класс)</h1>
      </div>

      <TrainerGate type="trainer:kombinatorika-3klass">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card mb-8 text-center">
              <p className="text-lg text-white/90 mb-6">
                Реши 10 задач на подсчёт вариантов: применяй правило умножения и считай перестановки.
                Прочитай условие внимательно и выбери верное число.
              </p>
