...
import { pickLogicTasks2Klass, type LogicTask2Klass } from '@/lib/logic-tasks-2klass';
...
export default function LogicheskieZadachi2KlassTrainerPage() {
  const [started, setStarted] = useState(false);
  const [rounds, setRounds] = useState<LogicTask2Klass[]>([]);
  ...
  function begin() {
    ...
    setRounds(pickLogicTasks2Klass(ROUNDS_PER_SESSION));
    setFeedback(null);
    setPickedIndex(null);
  }
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">🧠 Логические задачи (2 класс)</h1>
      </div>

      <TrainerGate type="trainer:logicheskie-zadachi-2klass">
        <div className="max-w-2xl mx-auto py-8 px-6">
          {!started && (
            <div className="card mb-8 text-center">
              <p className="text-lg text-white/90 mb-6">
                Реши 10 логических задач: сравнение, простой счёт, закономерности и «кто есть кто».
                Прочитай условие внимательно и выбери верный ответ.
              </p>
