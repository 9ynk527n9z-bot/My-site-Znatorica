...
// Для 3 класса берём меньшие числа (2-10 вместо 2-12 в 4 классе) — проще считать в уме.
...
export default function PloshchadPerimetr3klassTrainerPage() {
  ...
  return (
    <div className="min-h-screen">
      <div className="border-b border-white/15 px-6 py-4">
        ...
        <h1 className="text-2xl font-bold mt-2">📐 Площадь и периметр (3 класс)</h1>
      </div>

      <TrainerGate type="trainer:ploshchad-perimetr-3klass">
