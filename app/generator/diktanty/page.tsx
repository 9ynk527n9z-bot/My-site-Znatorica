...
export default function DiktantyGeneratorPage() {
  const [grade, setGrade] = useState<DictationGrade>(2);
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mt-2 mb-2">🎤 Генератор диктантов</h1>
        <p className="text-white/75 mb-8">
          Тренировочные тексты для диктанта под чтение взрослого — длина текста подобрана
          по возрасту, от коротких предложений в 1 классе до текстов подлиннее в 4 классе.
        </p>
