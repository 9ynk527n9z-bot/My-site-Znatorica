...
const TYPE_ORDER: SearchResultType[] = ['Тема', 'Тренажёр', 'Генератор', 'Таблица', 'ВПР', 'МЦКО', 'Плакат', 'Статья', 'Раздел'];

const TYPE_LABELS: Record<SearchResultType, string> = {
  Тема: 'Темы по возрастам',
  Тренажёр: 'Тренажёры',
  Генератор: 'Генераторы',
  Таблица: 'Учебные таблицы',
...
export default async function SearchPage({
  ...
  return (
    <div className="bg-[#28134f] min-h-screen py-16 px-6">
