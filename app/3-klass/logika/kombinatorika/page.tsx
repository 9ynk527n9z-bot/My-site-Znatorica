    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <div className="flex gap-4 mb-8 border-b border-[#2D2350] overflow-x-auto">
          ...
          <Link href="/trenazher/kombinatorika-3klass" className="px-6 py-3 border-b-2 border-transparent text-gray-400 hover:text-white transition-colors">🎮 Тренажер</Link>
        </div>
          ...
          <div className="space-y-6 text-lg">
            <div>
              ...
              <div className="mt-4 p-4 bg-orange/10 rounded">
                <p className="mb-2">У Пети 3 футболки и 2 пары шорт. Сколько разных комплектов «футболка + шорты» он может составить?</p>
        ...
        <TopicQuiz topic="3-klass/logika/kombinatorika" />
      </div>
    </div>
  );
}
