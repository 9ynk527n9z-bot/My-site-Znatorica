...
export function generateMetadata({ params }: Props): Metadata {
  ...
  if (!data) return {};
  return {
    title: `ВПР: ${shortSubject(data.subjectTitle)}, ${data.grade} класс — ${pluralizeCount(data.variants.length, ['вариант', 'варианта', 'вариантов'])}`,
    description: `${pluralizeCount(data.variants.length, ['тренировочный вариант', 'тренировочных варианта', 'тренировочных вариантов'])} ВПР с ответами по предмету «${data.subjectTitle}» для ${data.grade} класса. Решай онлайн с самопроверкой или распечатай на бумаге.`,
