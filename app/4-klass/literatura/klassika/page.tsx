    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <div className="flex gap-4 mb-8 border-b border-[#2D2350] overflow-x-auto">
          ...
          <Link
            href="/trenazher/klassika-4klass"
          ...
          <div className="space-y-6 text-lg">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                В 4 классе часто изучают сказки Пушкина, рассказы Толстого, басни Крылова и других русских классиков.
              </p>
        ...
        <div className="bg-gradient-to-r from-orange/20 to-violet/20 border border-orange rounded-lg p-8 text-center">
          ...
          <Link href="/trenazher/klassika-4klass" className="btn-primary text-lg px-8 py-4 inline-block">
            🎮 Открыть тренажер
          </Link>
        </div>

        <div className="mt-8">
          <TopicQuiz topic="4-klass/literatura/klassika" />
        </div>
      </div>
    </div>
  );
