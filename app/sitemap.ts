...
export const STATIC_ROUTES: string[] = [
  ...
  '/tablicy/zhivaya-nezhivaya-priroda',
  '/tablicy/organy-chuvstv',
  '/tablicy/prirodnye-zony-rossii',
  '/tablicy/solnechnaya-sistema',
  '/tablicy/kvadraty-chisel',
  '/tablicy/rimskie-cifry',
  '/tablicy/doli-i-drobi',
  '/tablicy/formuly-perimetra-i-ploshchadi',
  ...
  '/tablicy/glasnye-i-soglasnye-zvuki',
  '/tablicy/sinonimy-i-antonimy',
  ...
  '/tablicy/tsveta-po-anglijski',
  '/tablicy/semya-po-anglijski',
  '/tablicy/chasti-tela-po-anglijski',
