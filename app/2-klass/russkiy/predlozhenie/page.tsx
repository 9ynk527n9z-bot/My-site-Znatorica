    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <div className="flex gap-4 mb-8 border-b border-[#2D2350] overflow-x-auto">
          ...
          <Link href="/trenazher/predlozhenie-2klass" className="px-6 py-3 border-b-2 border-transparent text-gray-400 hover:text-white transition-colors">🎮 Тренажер</Link>
        </div>
        ...
        <TopicQuiz topic="2-klass/russkiy/predlozhenie" />
      </div>
    </div>
  );
}
