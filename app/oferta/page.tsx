...
import { SUBSCRIPTION_PRICE, LIFETIME_PRICE, TOURNAMENT_DIPLOMA_PRICE, TOURNAMENT_DIPLOMA_FREE } from '@/lib/constants';
  ...
  return (
    <div className="legal-page py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-sm mb-12">Последнее обновление: 12 августа 2026 г.</p>
        ...
        <div className="space-y-8">
          <section className="bg-[#2A1B4D] border border-[#2D2350] rounded-lg p-6">
            ...
            <p className="text-gray-400 mb-3">
              Заказчиком может быть только совершеннолетнее дееспособное физическое лицо. Если
              платформой фактически пользуется ребёнок, Заказчиком — стороной договора, ответственной за
              оплату и принятие условий, — является его родитель или законный представитель, действующий
              в интересах ребёнка.
            </p>
          ...
          <section className="bg-[#2A1B4D] border border-[#2D2350] rounded-lg p-6">
            ...
            <p className="text-gray-400 mb-3">
              ...
              вариантам для подготовки к ВПР для детей 4–11 лет. Помимо доступа по подписке, Исполнитель
              также реализует отдельные цифровые товары — готовые PDF-сборники заданий для скачивания
              и именные дипломы по результатам прохождения «Турнира Знаторики» (разовые покупки, не
              входят в подписку).
            </p>
            <p className="text-gray-400 mb-3">
              «Турнир Знаторики» — бесплатная развивающая викторина. Она не является олимпиадой,
              аттестацией или иной официально признаваемой формой оценки знаний и не даёт документа
              государственного образца. Именной диплом по её результатам — платный сувенирный документ
              с указанием имени и результата, не имеющий официального статуса.
            </p>
            <p className="text-gray-400">
          ...
          <section className="bg-[#2A1B4D] border border-[#2D2350] rounded-lg p-6">
            ...
            <ul className="text-gray-400 space-y-2 list-disc list-inside mb-3">
              ...
              <li>
                PDF-сборники — разовый платёж за конкретный сборник, без подписки; актуальная стоимость
                каждого сборника (включая временные акционные цены) указана на странице{' '}
              ...
              <li>
                Именной диплом «Турнира Знаторики»{' '}
                {TOURNAMENT_DIPLOMA_FREE ? (
                  <>
                    — в настоящее время предоставляется бесплатно; участие в самом турнире
                    также бесплатно. О возобновлении платы Исполнитель уведомляет изменением
                    настоящей оферты
                  </>
                ) : (
                  <>
                    — {TOURNAMENT_DIPLOMA_PRICE} ₽, разовый платёж за один диплом; участие
                    в самом турнире всегда бесплатно
                  </>
                )}
              </li>
              <li>
                Актуальная стоимость подписки всегда указана на странице{' '}
          ...
          <section className="bg-[#2A1B4D] border border-[#2D2350] rounded-lg p-6">
            ...
            <ul className="text-gray-400 space-y-2 list-disc list-inside">
              ...
              <li>
                Для PDF-сборников: возврат в полном объёме возможен в течение 7 дней с момента оплаты,
                если файл ещё не был скачан. После скачивания файла возврат не производится, так как
                цифровой товар считается предоставленным Заказчику в полном объёме
              </li>
              <li>
