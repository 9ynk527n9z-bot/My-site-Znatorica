...
export const metadata: Metadata = {
  title: 'Подписка 299 ₽/месяц — полный доступ ко всем материалам',
  description:
    'Оформите подписку на Знаторику за 299 ₽ в месяц: все тренажёры, генератор примеров без лимита, рабочие листы, плакаты и материалы для учителей. Оплата картой MIR, СБП, Сбербанк.',
...
const podpiskaFAQ = faqJsonLd([
  ...
  },
  {
    ...
    answer:
      'Пробного периода нет, но доступны бесплатные материалы: теория, шпаргалки и генератор до 10 раз в день.',
  },
]);
