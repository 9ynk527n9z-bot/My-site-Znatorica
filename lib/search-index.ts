...
const TOPIC_ENTRIES: SearchEntry[] = withType('Тема', [
  ...
  { title: 'Спряжение', url: '/3-klass/russkiy/spryazhenie', category: '4 класс · Русский язык' },
...
const GENERATOR_ENTRIES: SearchEntry[] = withType('Генератор', [
  ...
  { title: 'Английский алфавит — печатные и письменные буквы', url: '/generator/angliyskiy-alfavit', category: 'Генератор' },
  { title: 'Прописи (русский)', url: '/generator/propisi-ru', category: 'Генератор' },
  { title: 'Алфавит — печатные и письменные буквы', url: '/generator/alfavit', category: 'Генератор' },
  ...
  { title: 'Читательский дневник', url: '/generator/chitatelskiy-dnevnik', category: 'Генератор' },
  { title: 'Наклейки для подписи тетрадей и учебников', url: '/generator/nakleyki-na-tetradi', category: 'Генератор' },
  { title: 'Расписание звонков', url: '/generator/raspisanie-zvonkov', category: 'Генератор' },
  { title: 'Режим дня школьника', url: '/generator/rezhim-dnya-shkolnika', category: 'Генератор' },
  { title: 'Список вещей в школу', url: '/generator/spisok-v-shkolu', category: 'Генератор' },
  { title: 'Расписание кружков и секций', url: '/generator/raspisanie-kruzhkov', category: 'Генератор' },
  { title: 'График дежурств по классу', url: '/generator/grafik-dezhurstv', category: 'Генератор' },
  { title: 'Раздели на группы', url: '/generator/razdeli-na-gruppy', category: 'Генератор' },
...
const VPR_ENTRIES: SearchEntry[] = withType('ВПР', [
  ...
  { title: 'Подготовка к ВПР — Литературное чтение', url: '/vpr/4-klass/literaturnoe-chtenie', category: 'ВПР · 4 класс' },
]);
...
const MCKO_ENTRIES: SearchEntry[] = withType('МЦКО', [
  ...
  { title: 'МЦКО 2026 — География, 5 класс: 20 вариантов', url: '/podgotovka-k-mcko/5-klass/geografiya', category: 'МЦКО · 5 класс' },
  { title: 'МЦКО 2026 — Биология, 5 класс: 20 вариантов', url: '/podgotovka-k-mcko/5-klass/biologiya', category: 'МЦКО · 5 класс' },
  { title: 'МЦКО 2026 — Английский язык, 5 класс: 20 вариантов с аудио', url: '/podgotovka-k-mcko/5-klass/angliyskiy', category: 'МЦКО · 5 класс' },
  { title: 'МЦКО 2026 — Литература, 5 класс: 20 вариантов', url: '/podgotovka-k-mcko/5-klass/literatura', category: 'МЦКО · 5 класс' },
  { title: 'МЦКО 2026 — История, 5 класс: 20 вариантов', url: '/podgotovka-k-mcko/5-klass/istoriya', category: 'МЦКО · 5 класс' },
